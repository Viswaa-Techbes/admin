...
export function ReportsPage() {
  ...
  const stats = [
    { label: "Total Revenue", value: "₹24.8L", trend: "+12.5%", up: true, color: "#6366f1" },
    { label: "Avg. Job Value", value: "₹4,200", trend: "+5.2%", up: true, color: "#06b6d4" },
    { label: "Completion Rate", value: "94.2%", trend: "+2.1%", up: true, color: "#10b981" },
    { label: "Customer Satisfaction", value: "4.8/5", trend: "+0.3", up: true, color: "#f59e0b" },
  ];
  ...
  return (
    <div className="reports-container">
      <PageHeader 
        ...
        subtitle="Deep dive into business performance and technician productivity" 
        actions={
          <div style={{ display: "flex", gap: 10 }}>
            <select 
              value={period} 
              onChange={(e) => setPeriod(e.target.value)}
              style={{ ...INPUT_STYLE, padding: "8px 12px", background: "#fff" }}
            >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 20 }}>
        {stats.map((s, i) => (
          <Card key={i} style={{ padding: 20, borderLeft: `4px solid ${s.color}` }}>
            ...
            <div style={{ fontSize: 11, fontWeight: 700, color: s.up ? "#10b981" : "#f43f5e", display: "flex", alignItems: "center", gap: 4 }}>
              <span>{s.up ? "↑" : "↓"}</span> {s.trend} <span style={{ color: "#94a3b8", fontWeight: 400 }}>vs last period</span>
            </div>
          </Card>
        ))}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16, marginBottom: 16 }}>
        ...
        <Card style={{ padding: 24 }}>
          <SectionHeader title="Revenue & Request Growth" />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <Card style={{ padding: 24 }}>
          ...
          <div style={{ height: 300, width: "100%", marginTop: 20 }}>
            <ResponsiveContainer>
              <BarChart data={TECH_PERF} layout="vertical">
                ...
                <Bar dataKey="completed" fill="#10b981" radius={[0, 4, 4, 0]} barSize={20} name="Jobs Completed" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
        ...
        <Card style={{ padding: 24 }}>
          ...
          <div style={{ marginTop: 10 }}>
            <TableWrapper 
              headers={["Technician", "Completed", "Rating", "Status"]}
              rows={TECH_PERF.sort((a,b) => b.completed - a.completed).slice(0, 5).map((t, i) => (
                <tr key={i} style={{ borderBottom: "1px solid #f1f5f9" }}>
                  ...
                  <td style={TD_STYLE}><StatusBadge status={i < 2 ? "High Performance" : "Active"} /></td>
                </tr>
              ))}
            />
          </div>
