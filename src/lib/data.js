...
export const STATUS_BADGE = {
  ...
  "VIP": { bg: "rgba(245,158,11,0.12)", color: "#f59e0b", dot: "#f59e0b" },
  "Inactive": { bg: "rgba(100,116,139,0.12)", color: "#64748b", dot: "#64748b" },
  "Not Active": { bg: "rgba(244,63,94,0.12)", color: "#f43f5e", dot: "#f43f5e" },
  "Available": { bg: "rgba(16,185,129,0.12)", color: "#10b981", dot: "#10b981" },
  "On Job": { bg: "rgba(6,182,212,0.12)", color: "#06b6d4", dot: "#06b6d4" },
